...
<template>
    <Form
      ...
      v-slot="{ errors }"
    >
        <div class="flex flex-col gap-6 mb-6 laptop:flex-row laptop:justify-between" >
        ...
        <EntityFormBlockSubTitle class="mr-auto mb-6" title="Your account type:" />
          ...
          <div>
                <h3 class="font-semibold text-[20px] leading-[120%] text-[#1D3557] mt-[56px] mb-6">Change your password</h3>
